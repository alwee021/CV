...
Ft=exp(-t.^2*2.25).*sin(t.*thetamax).*(exp((R(round(t.*200+1))-1)/0.002.*tan(t.*thetamax).*1)-exp(-(1-R(round(t.*200+1)).*exp(-1.*0.002.*1./sin(t.*thetamax)))/0.002.*tan(t.*thetamax).*1));         
